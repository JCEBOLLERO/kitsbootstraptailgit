            ...
            <div class="card">
                <div class="card-body p-4">
                    <form action="{{ route('facturas.store') }}" method="POST">
                        @csrf
                        <div x-data="clientSelector({ clientes: @js($clientes) })"
                         class="mb-4">
                            <template x-for="cliente in clients" :key="cliente.id"> </template>                            


                        <!-- <div class="mb-4"> -->
                            <label for="codcliente" class="form-label">Código de Cliente</label>
                            <input type="text" name="codcliente" id="codcliente" class="mb-2 form-control @error('codcliente') is-invalid @enderror"
                            value = "{{ old('codcliente') }}"
                            placeholder="Introduce el código del cliente" autofocus
                            x-model="clientCode"
                            @keyup.debounce="findClientByCode()">
                            <!-- @change="findClientByCode()" -->
                            ...
                            <div class="col-md-2 d-flex align-items-end">
                                <button type="button" class="btn btn-secondary v-100"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <!-- <template x-for="cliente in filteredClients" :key="cliente.code"> -->
                                                        <tr>
                                                            <td>{{ $c->id }}</td>
                                                            <td>{{ $c->nombre }}</td>
                                                            <td></td>
